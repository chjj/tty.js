...
app.get('/options.js', function(req, res, next) {
  res.contentType('.js');
  // res.send('Terminal.options = ' + options
  //   + ';Terminal.fgColors = Terminal.options.fgColors || Terminal.fgColors'
  //   + ';Terminal.bgColors = Terminal.options.bgColors || Terminal.bgColors'
  //   + ';');
  res.send('Terminal.options = ' + options
    + ';\n' + '(' + applyConfig + ')();');
});
