...
function checkConfig(conf) {
  ...
  conf.term.escapeKey; // 192
  conf.escapeKey = conf.term.escapeKey || conf.escapeKey;
  if (conf.escapeKey) {
    conf.term.escapeKey = typeof conf.escapeKey === 'string'
      ? conf.escapeKey
      : '`';
    //conf.term.escapeKey = typeof conf.escapeKey === 'number'
    //  ? conf.escapeKey
    //  : 192;
  }
